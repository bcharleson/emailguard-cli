...
export class AuthError extends EmailGuardError {
...
export class NotFoundError extends EmailGuardError {
  constructor(message: string) {
...
export class ValidationError extends EmailGuardError {
  constructor(message: string) {
...
export class RateLimitError extends EmailGuardError {
...
export class ServerError extends EmailGuardError {
